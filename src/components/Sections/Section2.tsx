...
export default function () {
	return (
		<section className="relative flex h-[900px] w-full flex-col p-[4.375rem] tablet:p-[1.875rem] mobile:h-[800px]">
			...
			<div className="my-auto grid grid-cols-4 justify-items-center tablet:hidden">
